...
//	int iN,hN,oN;
	...
	maps_info_1.l1_maps = 16;
	maps_info_1.l2_maps = 64;
...
operateLayer1(short* img_ptr, uint32_t w, uint32_t h)
{
    ...
    {
    	Conv5x5(img_ptr,temp_img_ptr,w,h,&kernel5x5[i][0]);
...
operateLayer2(uint32_t w, uint32_t h)
{
    ...
    for (i = 0; i<local_l2_maps; i++)
    {
        ...
        Conv7x7(maps_info_ptr->l1_maps_ptr,layer1_ptr, w, h, &kernel7x7[i][0]);
        ...
        maxpool(layer1_ptr,(maps_info_ptr->l2_maps_ptr+(i*l2_size)), w, h);
    }
}
